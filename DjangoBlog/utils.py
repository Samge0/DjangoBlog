...
def get_blog_setting():
    ...
    if value:
        ...
        if not BlogSettings.objects.count():
            ...
            setting.sitename = 'Samge'
            setting.site_description = '个人博客：善始者实繁，克终者盖寡'
            setting.site_seo_description = '个人博客：善始者实繁，克终者盖寡'
            setting.site_keywords = 'Samge,个人博客,Java,Android,Kotlin,Django,Python'
